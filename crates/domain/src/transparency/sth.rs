...
pub fn verify_sth(
    ...
    let payload =
        canonical_payload(&sth.root_hash, sth.tree_size, sth.timestamp_epoch_seconds);
...
mod tests {
    ...
    fn test_signing_key() -> SigningKey {
        let seed: [u8; 32] = [
            0x0f, 0x1e, 0x2d, 0x3c, 0x4b, 0x5a, 0x69, 0x78, 0x87, 0x96,
            0xa5, 0xb4, 0xc3, 0xd2, 0xe1, 0xf0, 0x01, 0x12, 0x23, 0x34,
            0x45, 0x56, 0x67, 0x78, 0x89, 0x9a, 0xab, 0xbc, 0xcd, 0xde,
            0xef, 0xf0,
        ];
